...
public class TransactionRepositoryTest {
    ...
    public void before(){
        ...
        transaction = new Transaction(/*String.valueOf(UUID.randomUUID()),*/typeCredit, 5, wallet1, 1L);
    ...
    public void testSave_Credit() {
        ...
        Transaction transaction = new Transaction(/*String.valueOf(UUID.randomUUID()),*/typeCredit,20,wallet2, 1L);
    ...
    public void testSave_Debit() {
        ...
        Transaction transaction = new Transaction(/*String.valueOf(UUID.randomUUID()),*/typeDebit,10,wallet2, 2L);
        Transaction found = transactionRepository.save(transaction);
        assertNotNull(found);
    ...
    public void testSave_NotUniqueGlobalId() {
        ...
        Transaction transaction = new Transaction(/*String.valueOf(-1),*/typeDebit,10,wallet2, 2L);
        try{
    ...
    public void whenSave_NoBalance() {
        ...
        Transaction transaction = new Transaction(/*String.valueOf(UUID.randomUUID()),*/typeCredit,10,wallet2,2L);
        try{
            Transaction found = transactionRepository.save(transaction);
            entityManager.flush();
            fail();
    ...
    public void whenSave_FailWrongWallet() {
        ...
        Transaction transaction = new Transaction(/*String.valueOf(UUID.randomUUID()),*/typeDebit,10,wallet,3L);
        try{
            Transaction found = transactionRepository.save(transaction);
            entityManager.flush();
            fail();
